        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
              <span className="gradient-text">Maximize your</span> <span className="gradient-text">DeFi returns</span>
            </h1>
            ...
            <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12">
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-lg font-semibold leading-8 text-white">Connect your wallet</p>
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-lg font-semibold leading-8 text-white">Deposit your assets</p>
                  <p className="mt-2 text-base leading-7 text-gray-300">
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-lg font-semibold leading-8 text-white">Choose your strategy</p>
                  <p className="mt-2 text-base leading-7 text-gray-300">
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-lg font-semibold leading-8 text-white">Earn optimized yields</p>
                  <p className="mt-2 text-base leading-7 text-gray-300">
