    ...
    return [
      {
        ...
        asset: '0x... (native OG token address)',
        assetSymbol: 'OG',
        tvl: 5000000,
        apy: 18.0,
        risk: 4,
        type: 'staking',
        strategyAddress: '0x0gstaking123456789012345678901234567890123',
        description: 'Stake OG tokens on the 0G Galileo Testnet to secure the network and earn rewards.',
        isAudited: true,
        lockupPeriod: 14,
        tags: ['0g', 'staking', 'testnet']
      }
    ];
  };
